...
{
	private static Joiner pipe = Joiner.on("|");
	private static List<String> REGIONS = ImmutableList.of(
		"Misthalin","Karamja", "Asgarnia", "Fremennik Provinces",
		"Kandarin", "Kharidian Desert", "Morytania", "Tirannwn", "Wilderness");
