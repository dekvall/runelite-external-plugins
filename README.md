# Push Notifications
Forward notifications to your phone or other devices, currently supports [Pushbullet](https://www.pushbullet.com/), [Pushover](https://pushover.net/), [Pushcut](https://www.pushcut.io/) and [Gotify](https://gotify.net).
